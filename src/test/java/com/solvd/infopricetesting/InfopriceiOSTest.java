...
public class InfopriceiOSTest implements IAbstractTest, IMobileUtils {
...
//        softAssert.assertTrue(returnedHomePage.isPageOpened(10), "Home page is not opened");
        ...
        String currentUrl = returnedHomePage.getTextOfTitle();
        softAssert.assertEquals(currentUrl, "https://infoprice.by/",
